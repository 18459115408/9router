...
// WorkBuddy (international) refresh — same endpoint shape as CodeBuddy, on the
// WorkBuddy host. X-Refresh-Token is ONLY ever sent here, never on chat/billing
// (upstream treats it as an auth-class header).
