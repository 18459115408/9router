 ...
 */
export async function handleStreamingResponse({ providerResponse, provider, model, sourceFormat, targetFormat, userAgent, body, stream, translatedBody, finalBody, requestStartTime, connectionId, connectionName, apiKey, clientRawRequest, onRequestSuccess, reqLogger, toolNameMap, customToolNames, streamController, onStreamComplete, streamDetailId, pxpipe, reqTag, log, credentials, clientRequestConfig }) {
  if (onRequestSuccess) {
    Promise.resolve()
  ...
  saveRequestDetail(buildRequestDetail({
    ...
    connectionName: connectionName || credentials?.connectionName,
 ...
 */
export function buildOnStreamComplete({ provider, model, connectionId, connectionName, apiKey, requestStartTime, body, stream, finalBody, translatedBody, clientRawRequest, pxpipe, reqTag, log, clientRequestConfig }) {
