 ...
 */
export function buildOnStreamComplete({ provider, model, connectionId, connectionName, apiKey, requestStartTime, body, stream, finalBody, translatedBody, clientRawRequest, pxpipe, reqTag, log }) {
