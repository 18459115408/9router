              ...
              {loading ? (
                ...
                details.map((detail, index) => (
                  ...
                  >
                    ...
                    <td className="max-w-[180px] truncate p-4 text-sm text-text-main" title={detail.connectionName || ""}>
          ...
          <div className="space-y-6">
            <div className="grid min-w-0 grid-cols-1 gap-4 text-sm sm:grid-cols-2">
              ...
              <div>
                ...
                <span className="text-text-main font-medium" title={selectedDetail.connectionName || ""}>
                  {selectedDetail.connectionName || "—"}
                </span>
              </div>
              <div>
